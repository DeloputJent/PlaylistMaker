...
class TracksInPlaylistViewHolder (private val binding: TrackFrameViewBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    companion object {
        fun from(parent: ViewGroup): TracksInPlaylistViewHolder {
            val inflater = LayoutInflater.from(parent.context)
            val binding = TrackFrameViewBinding.inflate(inflater, parent, false)
            return TracksInPlaylistViewHolder(binding)
        }
    }
